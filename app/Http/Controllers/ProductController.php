...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        //view always goto pages, but route not say pages
    ...
    public function store(Request $request)
    {
        ...
        return redirect()-> route('products.index')->with('success','Saved succefully.');
    ...
    {
        return view('interface.show',compact('product'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('interface.edit',compact('product'));
    }
